...
//  Story App
//
//  Created by Elizabeth Macris on 4/4/16.
//  Copyright © 2016 Advanced Primate Minds. All rights reserved.
//
        ...
        if segue.identifier == "startAdventure" {
            do {
                if let name = nameTextField.text {
                    ...
                    if let pageController = segue.destinationViewController as?
                            PageController {
